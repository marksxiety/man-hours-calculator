<h1 align="center">Man-Hours Calculator</h1>

<p align="center">
  <a href="https://github.com/marksxiety/man-hours-calculator/actions/workflows/tests.yml">
    <img src="https://github.com/marksxiety/man-hours-calculator/actions/workflows/tests.yml/badge.svg" alt="Tests">
  </a>
  <a href="https://github.com/marksxiety/man-hours-calculator/actions/workflows/build.yml">
    <img src="https://github.com/marksxiety/man-hours-calculator/actions/workflows/build.yml/badge.svg" alt="Build">
  </a>
  <a href="https://github.com/marksxiety/man-hours-calculator/actions/workflows/lints.yml">
    <img src="https://github.com/marksxiety/man-hours-calculator/actions/workflows/lints.yml/badge.svg" alt="Lint">
  </a>
  <a href="https://github.com/marksxiety/man-hours-calculator/blob/main/LICENSE">
    <img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="MIT License">
  </a>
</p>

> "It'll probably take two days." Three weeks later, it's still not done — and nobody can say exactly where the estimate fell apart.

Every developer has quoted a task off gut feeling and paid for it later. **Man-Hours Calculator** replaces that gut feeling with a disciplined, statistical estimate — using **PERT (Program Evaluation and Review Technique)**, a technique project managers have relied on for decades to turn uncertainty into a defensible number.

---

## The Problem With Single-Number Estimates

A single-number estimate hides a lie: it pretends you're certain about something you're not. It doesn't distinguish between a task you've done a hundred times and one with three unknown dependencies buried inside it. When reality diverges from that one number, there's no data trail to explain why — just a missed deadline and an uncomfortable conversation.

PERT fixes this by asking a different question. Instead of "how long will this take?", it asks **"what are the best case, worst case, and most likely case — and how confident are we, really?"**
...
- **Developer Feedback Loop:** Lets you self-correct unrealistic estimates by seeing the mathematical impact of your inputs immediately.
...
To eliminate **Estimation Debt** by applying a mathematical approach to quoting that accounts for uncertainty — giving developers and stakeholders the same transparent, defensible number to plan around.
