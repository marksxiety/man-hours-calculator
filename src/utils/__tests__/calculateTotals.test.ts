...
describe('calculateTotalVariance', () => {
  it('calculates total variance correctly', () => {
    const tasks: PERTTaskResult[] = [
      { taskName: 'Task 1', optimistic: 2, mostLikely: 5, pessimistic: 8, expectedTime: 5, standardDeviation: 1, variance: 1 },
      { taskName: 'Task 2', optimistic: 1, mostLikely: 4, pessimistic: 7, expectedTime: 4, standardDeviation: 1, variance: 1 }
    ]
  ...
  it('handles tasks with zero variance', () => {
    const tasks: PERTTaskResult[] = [
      { taskName: 'Task 1', optimistic: 5, mostLikely: 5, pessimistic: 5, expectedTime: 5, standardDeviation: 0, variance: 0 },
      { taskName: 'Task 2', optimistic: 5, mostLikely: 5, pessimistic: 5, expectedTime: 5, standardDeviation: 0, variance: 0 }
    ]
    expect(calculateTotalVariance(tasks)).toBe(0)
  })
  ...
  it('handles large variance values', () => {
    const tasks: PERTTaskResult[] = [
      { taskName: 'Task 1', optimistic: 2, mostLikely: 5, pessimistic: 14, expectedTime: 6, standardDeviation: 2, variance: 4 },
      { taskName: 'Task 2', optimistic: 1, mostLikely: 4, pessimistic: 10, expectedTime: 4.5, standardDeviation: 1.5, variance: 2.25 }
    ]
  ...
  it('rounds to 3 decimal places', () => {
    const tasks: PERTTaskResult[] = [
      { taskName: 'Task 1', optimistic: 1, mostLikely: 3, pessimistic: 5, expectedTime: 3, standardDeviation: 0.667, variance: 0.445 },
      { taskName: 'Task 2', optimistic: 1, mostLikely: 3, pessimistic: 5, expectedTime: 3, standardDeviation: 0.667, variance: 0.445 }
    ]
